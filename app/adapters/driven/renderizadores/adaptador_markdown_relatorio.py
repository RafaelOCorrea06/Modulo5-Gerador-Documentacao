...
class AdaptadorMarkdownRelatorio:
    """
    Adaptador responsável por transformar um DocumentoTecnico em Markdown.

    Este adaptador é usado pela GD-01 para geração de relatórios técnicos.
    Ele fica separado do adaptador de Markdown da GD-06, que é usado para
